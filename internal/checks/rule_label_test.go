	...
	testCases := []checkTest{
		{
			...
			checker:     checks.NewLabelCheck("severity", checks.MustTemplatedRegexp("critical"), true, checks.Warning),
		...
		},
		{
			...
			content:     "- record: foo\n  expr: rate(foo[1m])\n",
			checker:     checks.NewLabelCheck("severity", checks.MustTemplatedRegexp("critical"), false, checks.Warning),
		},
		{
		...
		},
		{
			...
			content:     "- record: foo\n  expr: rate(foo[1m])\n  labels:\n    priority: 2a\n",
			checker:     checks.NewLabelCheck("priority", checks.MustTemplatedRegexp("(1|2|3)"), true, checks.Warning),
			problems: []checks.Problem{
				{
		...
		},
		{
			...
			content:     "- record: foo\n  expr: rate(foo[1m])\n  labels:\n    priority: 2a\n",
			checker:     checks.NewLabelCheck("priority", checks.MustTemplatedRegexp("(1|2|3)"), false, checks.Warning),
			problems: []checks.Problem{
				{
					Fragment: "priority: 2a",
					Lines:    []int{4},
		...
		},
		{
			...
			content:     "- alert: foo\n  expr: rate(foo[1m])\n  labels:\n    severity: warning\n",
			checker:     checks.NewLabelCheck("severity", checks.MustTemplatedRegexp("critical|info"), true, checks.Warning),
			problems: []checks.Problem{
				{
					Fragment: "severity: warning",
					Lines:    []int{4},
		...
		},
		{
			...
			content:     "- alert: foo\n  expr: rate(foo[1m])\n  labels:\n    severity: warning\n",
			checker:     checks.NewLabelCheck("severity", checks.MustTemplatedRegexp("critical|info"), false, checks.Warning),
			problems: []checks.Problem{
				{
					Fragment: "severity: warning",
					Lines:    []int{4},
		...
		},
		{
			...
			checker:     checks.NewLabelCheck("for", checks.MustTemplatedRegexp("must wait {{$for}} to fire"), true, checks.Warning),
		},
		{
