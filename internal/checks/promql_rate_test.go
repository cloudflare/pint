			...
			problems: []checks.Problem{
				{
					...
					Text:     fmt.Sprintf(`duration for rate() must be at least 2 x scrape_interval, "prom" on %s is using 1m scrape_interval`, srv.URL+"/1m/"),
					Severity: checks.Bug,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`duration for rate() is recommended to be at least 4 x scrape_interval, "prom" on %s is using 1m scrape_interval`, srv.URL+"/1m/"),
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`duration for irate() must be at least 2 x scrape_interval, "prom" on %s is using 1m scrape_interval`, srv.URL+"/1m/"),
					Severity: checks.Bug,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`duration for irate() is recommended to be at least 3 x scrape_interval, "prom" on %s is using 1m scrape_interval`, srv.URL+"/1m/"),
					Severity: checks.Warning,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`cound't run "promql/rate" checks due to "prom" on %s/error/ connection error: failed to query Prometheus config: server_error: server error: 500`, srv.URL),
					Severity: checks.Bug,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`query using "prom" on %s failed with: failed to query Prometheus config: bad_data: unhandled path`, srv.URL),
					Severity: checks.Bug,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf("cound't run \"promql/rate\" checks due to \"prom\" on %s/badYaml/ connection error: failed to decode config data in %s/badYaml/ response: yaml: unmarshal errors:\n  line 1: cannot unmarshal !!str `invalid...` into promapi.PrometheusConfig", srv.URL, srv.URL),
					Severity: checks.Bug,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     `cound't run "promql/rate" checks due to "prom" on http:// connection error: failed to query Prometheus config: Get "http:///api/v1/status/config": http: no Host in request URL`,
					Severity: checks.Warning,
				},
			},
		},
			...
			problems: []checks.Problem{
				{
					...
					Lines:    []int{2},
					Reporter: "promql/rate",
					Text:     fmt.Sprintf(`duration for irate() is recommended to be at least 3 x scrape_interval, "prom" on %s is using 1m scrape_interval`, srv.URL+"/default/"),
					Severity: checks.Warning,
				},
			},
		},
